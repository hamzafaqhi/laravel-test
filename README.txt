...
5. Seprate repository should be created like both users and jobs are direclty used in BookingRepository seprating the repositories will result in clear and consice code easy to read and understand.